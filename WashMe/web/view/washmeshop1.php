	...
	session_start();
	 ...
	 <div class="big-body">
		...
		<div class="box-right">
			...
			<div class="flex">
				<div class="border1">Search Product / Shop</div>
				<div class="border2"><img src="../asset/images/search.png" class="img"></div>
			...
			<div class="background-img">
				...
				<div class="flex">
					<div class="box2">
						<img src="../asset/images/iron.png" class="img">
						<div class="text">Iron</div>
					</div>
					<div class="box2">
						<img src="../asset/images/hanger.png" class="img">
						<div class="text">Hangers</div>
					</div>
					<div class="box2">
					...
					<div class="box2">
						<img src="../asset/images/laundry-basket.png" class="img">
						<div class="text">Laundry Basket</div>
					</div>
					<div class="box2">
						<img src="../asset/images/detergent.png" class="img">
						<div class="text">Detergents</div>
					</div>
				</div>
			</div>
