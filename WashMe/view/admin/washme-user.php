...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../asset/css/admin/washme-user.css">
...
<form>
	<div class="container-fluid-screen">
		...
		<div class="content">
			<div class="box">
				<div class="text">User's Account</div>
				<a href="useraccount.php"><img src="../../asset/images/clothes2.png"></a>
			</div>
			<div class="box">
