...
<body>
	<div class="container-fluid-fullscreen">
		...
		<div class="row">
			<div class="col-lg-12 headd text-center"><b>Find <span style="color:#095a5f;">Your Book</span> Easily</b></div>
		</div>
		<div class="row text-center top">
			...
			<div class="col-lg-3 font1"><a href="profileweb.php"><u>PROFILE</u></a></div>
		</div>
		<div class="background">
			...
			<div class="row">
				<div class="col-lg-4"></div>
				<div class="col-lg-4 text-center wid"><b>Username : <span style="color:#095a5f;">Feliciano123</span></b></div>
				<div class="col-lg-4"></div>
			</div>
			<div class="row">
				<div class="col-lg-4"></div>
				<div class="col-lg-4 text-center wid"><b>Email : <span style="color:#095a5f;">Suryamarcello@gmail.com</span></b></div>
				<div class="col-lg-4"></div>
			</div>
		</div>
	</div>
