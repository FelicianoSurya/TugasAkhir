...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2019 at 11:02 AM
...
(1, 1, '2019-04-30', 20000),
(2, 2, '2019-05-01', 36000),
(3, 0, '', 0),
(4, 3, '2019-04-30', 42000),
(5, 0, '', 0);
...
--
ALTER TABLE `temptransaksi`
  MODIFY `notemp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
